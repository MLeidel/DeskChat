...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        ent_btncolor['values'] = ('default',
                                ...
                                'light',
                                'dark')
        ent_btncolor.current(0)
        ent_btncolor.grid(row=10, column=2, sticky='w', pady=4, padx=4)
        ...
        self.vent_btncolor.set(MyButtons)
        ...
        ToolTip(btn_models,
                text="Edit options.ini\nin text editor",
                bootstyle=(INFO, INVERSE))


    def edit_models(self):
        ''' use MyEditor to edit options.ini file
    ...
    def on_close(self):
        ...
        config['Main']['btncolor']   = self.vent_btncolor.get().strip()
...
MyButtons = config['Main']['btncolor']
